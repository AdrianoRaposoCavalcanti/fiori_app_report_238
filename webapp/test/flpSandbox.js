		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori Report",
									"targetURL": "#brcomgestaofioriappreport238-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"brcomgestaofioriappreport238-display": {
								"semanticObject": "brcomgestaofioriappreport238",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=br.com.gestao.fioriappreport238",
									"url": sap.ui.require.toUrl("br/com/gestao/fioriappreport238")
								}
							}
						}
					}
